...
const MessagesMenu = () => {
  return (
    <MenuDropdown title="Messages" trigger={<IconButtonDropdown icon={<HiOutlineEnvelope />} />}>
      {Array.from({ length: 5 }).map((_, i) => {
        return (
          <ButtonDropdownItem key={i} className="items-start border-b border-gray-100 py-4 transition hover:bg-gray-50">
